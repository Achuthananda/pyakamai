...
class AkamaiIdentity():
    ...
    def listAPIClients(self):
        ep = '/identity-management/v3/api-clients'
        params = {}
    ...
    def getCredentials(self,clientID):
        ep = '/identity-management/v3/api-clients/{}/credentials'.format(clientID)
        params = {}
        if self.accountSwitchKey:
            params['accountSwitchKey']= self.accountSwitchKey
            status,result = self._prdHttpCaller.getResult(ep,params=params)
